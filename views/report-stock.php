...
<div class="container-fluid mx-auto d-block" style="max-width:100%;">
        <h2 class="align text-center"> Stocks Report Generation Module </h2>
        <br><br>
        <div class="chart">
...
<script>
    ...
    var values = json.map(function(e) {
        return e.totalstocks;
    });
    console.log(values);
    var chart = BuildChart(labels, values, " Total Stocks Over Montlhy (Year 2020)");
</script>
