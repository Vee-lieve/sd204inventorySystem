...
=======
                    ...
                    <a class="dropdown-item" href="register.php">Log Out</a>
>>>>>>> 9d82e5c02db42d06b2bd292a01602d2ab4bb059c
                </div>
         </ul>
    </div>
</nav>  
...
<<<<<<< HEAD
            ...
            <div id='submenu5' class="collapse sidebar-submenu">
                <a href="../public/sales-rep.php" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed">Sales</span>
                </a>
                <a href="..public/stock-rep.php" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed">Stocks</span>
                </a>
                <a href="..public/cashflow.php" class="list-group-item list-group-item-action bg-dark text-white">
